...
AUDIT_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "difficulty": "hard",
        "population": 200,
        "expected_findings": [{"type": "round_number_flag", "count": 1}],
        "severity_on_failure": "medium",
    ...
    },
    {
        ...
        "difficulty": "hard",
        "population": 60,
        "expected_findings": [{"type": "near_duplicate_invoice_number", "count": 1}],
        "severity_on_failure": "medium",
    ...
    # ---- sampling ----
    {
        ...
        "difficulty": "normal",
        "population": 300,
        "expected_findings": [],  # feature not yet implemented; records a 'known gap' pass
        "severity_on_failure": "medium",
    ...
    # ---- trial balance ----
    {
        ...
        "difficulty": "hard",
        "population": 50,
        "expected_findings": [],  # TB imbalance alert rule not yet implemented
        "severity_on_failure": "critical",
        "description": "Injected 1-cent TB imbalance — must surface (KNOWN GAP)",
    },
    # ---- clean/baseline ----
    {
