...
4. Cliquez Oui/Yes si Windows demande la permission
   Click Yes/Oui if Windows asks for permission
5. Attendez 5 minutes - le navigateur s'ouvrira automatiquement
   Wait 5 minutes - the browser will open automatically
